...
description: Detect which AI tool the user runs and write the matching ai-harness adapter file(s). Claude Code, Codex, Pi, and GitHub Copilot CLI are fully automated; other tools are recognized and given a manual snippet. Used by /sth-harness:init and the Codex/Pi/Copilot CLI sth-harness skill.
---
...
- If there is no signal, ask the user to choose from: Claude Code, Codex,
  GitHub Copilot CLI, GitHub Copilot IDE, Gemini CLI, Pi, Aider, Other.
